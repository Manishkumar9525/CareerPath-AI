    ...
    <footer className="border-t border-green-500/20 dark:border-white/10 mt-10">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-12">
        ...
        <div>
          <div
            onClick={() => navigate("/")}
            className="flex items-center gap-2 text-primary text-lg font-semibold mb-4 cursor-pointer"
          >
        ...
        <div>
          ...
          <ul className="space-y-2 text-green-600/70 dark:text-white/60 text-sm">
            ...
            <li
              ...
              className="hover:text-green-700 dark:hover:text-white cursor-pointer transition"
            >
              Features
            </li>
